...
class MJXGUI {
    constructor(elementSelector, successCallback, options={}) {
    ...
    constructUI() {
        ...
        mjxguiTabButtons.forEach(btn => {
            btn.addEventListener('click', () => {
                mjxguiTabButtons.forEach(tabBtn => {tabBtn.classList.remove('_mjxgui_active_tab')});
