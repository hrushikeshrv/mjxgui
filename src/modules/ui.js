...
class MJXGUI {
  constructor(
    ...
    this.toggleDarkMode = () => {
      ...
      // if (!editorDiv.classList.contains("dark-mode")) {
      //   editorDiv.classList.add("dark-mode");
      // } else {
      //   editorDiv.classList.remove("dark-mode");
      // }
      editorDiv.classList.toggle("dark-mode");

      const childElements = editorDiv.querySelectorAll("*");
  ...
  constructUI() {
    ...
    const leftArrowButton = editorDiv.querySelector(
      ".leftArrowButton"
    );
    const rightArrowButton = editorDiv.querySelector(
      ".rightArrowButton"
    );
    ...
    toggleDarkModeButton.id = "toggle_dark_mode_button";
    ...
    editorDiv.appendChild(toggleDarkModeButton);
